          ...
          <div class="hero__wrapper">
            ...
            <div class="hero__box">
              ...
              <div class="hero__box-inner">
                ...
                <a href="<?php the_sub_field( 'hero__box-link' ); ?>" class="hero__box-link" style="background: <?php the_sub_field( 'hero__box-link-color' ); ?>;"><?php the_sub_field( 'hero__box-link-text' ); ?></a>
              </div>
                <?php endwhile; ?>
		          <?php endif; ?>
        ...
        <div class="container">
          ...
          <div class="types__wrapper">
            ...
            <div class="types__item">
              ...
              <a href="<?php the_sub_field( 'types__item-link' ); ?>" class="types__item-link" style="background: <?php the_sub_field( 'types__item-link-color' ); ?>;">&lt; <?php the_sub_field( 'types__item-link-text' ); ?> &gt;</a>
            </div>
              <?php endwhile; ?>
            <?php else : ?>
            	<?php // no rows found ?>
