        ...
        <div className="header__navbar flex justify-between items-center w-full">
          ...
          <nav className="header__menu flex">
            <div className="header__language mr-md relative cursor-pointer pr-md lg:pr-md">
              <p className="header__language-trigger relative after:absolute after:bg-[url('../images/decor/arrow-down-mobile.svg')]  after:transition-all after:w-[15px] after:h-[10px] after:bg-no-repeat after:top-[37%] after:translate-y-[-50%] after:left-[120%]">
                ENG
              </p>
              <div className="header__language-menu opacity-0 invisible pointer-events-none transition-all">
                <Link
                  href="/ua/"
