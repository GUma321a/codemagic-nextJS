    ...
    <section className="contact mt-[100px] mb-60 md:mt-[200px] lg:mb-160">
      <div className="container">
        <div className="caption-wrapper max-w-[624px] mx-auto">
          <p className="contact__caption caption-s">Зв'язок зі мною</p>
          <h2 className="contact__title heading-h2 mb-md">
            Давайте щось побудуємо разом... Зв'яжіться зі мною.
          </h2>
          ...
          >
            <div className="contact__form-inner mb-lg">
              <p className="contact__form-title text-gray-200 mb-[12px]">Ім'я</p>
              <input
            ...
            <div className="contact__form-inner mb-lg">
              <p className="contact__form-title text-gray-200 mb-[12px]">Пошта</p>
              <input
                className="w-full border-solid border-b border-gray-500 p-[10px] hover:border-primary-light focus:border-primary-light"
                type="email"
                name="Email"
            ...
            <div className="contact__form-message">
              <p className="contact__form-title text-gray-200 mb-[12px]">Повідомлення</p>
              <textarea
            ...
            >
              <span className="send-text">Почати проєкт</span>
              <span className="success-text">Повідомлення відправлено!</span>
            </button>
          </form>
        </div>
      </div>
